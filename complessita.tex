...
\marginpar{Una definizione}La definizione di complessità che propongo è la seguente:
\begin{quote}
...
\marginpar{Sul pluralismo}Per chiudere la sezione mi soffermo su un dibattito vivo in molte discipline, tra cui l'economia, sulla coesistenza di teorie alternative e il problema di scegliere una teoria rispetto a un'altra. Il dibattito sul pluralismo. 
...
\marginpar{Una breve storia}La seconda parte di questo articolo cerca di contestualizzare quanto scritto finora allo stato attuale della disciplina economica, individuando in particolare tre relazioni archetipiche
...
\marginpar{Quale realismo?}È lecito chiedersi quando fare ricerca facendo propri i principi di una meta-teoria della complessità sia realistico.
